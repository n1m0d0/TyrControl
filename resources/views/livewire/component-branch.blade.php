<div class="mt-2">
                ...
                @foreach ($branches as $branch)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $branch->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $branch->id }})'
    ...
    <flux:modal name="branch-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
            ...
            <flux:input wire:model='form.name' label="{{ __('Name') }}"
                placeholder="{{ __('Example') }}: San Pedro" />
            ...
            <flux:select class="mt-2" wire:model="form.company">
    ...
    <flux:modal name="branch-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
