<div class="mt-2">
                ...
                @foreach ($suppliers as $supplier)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $supplier->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $supplier->id }})'
    ...
    <flux:modal name="supplier-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
            ...
            <flux:input wire:model='form.name' label="{{ __('Name') }}" placeholder="{{ __('Example') }}: SARE" />

            <flux:input wire:model='form.contact' label="{{ __('Contact') }}"
                placeholder="{{ __('Example') }}: John Doe" />

            <flux:input wire:model='form.address' label="{{ __('Address') }}"
                placeholder="{{ __('Example') }}: Av. San Pedro" />

            <flux:input wire:model='form.phone' label="{{ __('Phone') }}"
                placeholder="{{ __('Example') }}: 78945612" />
    ...
    <flux:modal name="supplier-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
