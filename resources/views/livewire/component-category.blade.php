<div class="mt-2">
        ...
        <div class="relative">
            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewcategory="0 0 20 20">
                ...
                @foreach ($categories as $category)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $category->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $category->id }})'
    ...
    <flux:modal name="category-form" class="md:w-120">
        <div class="space-y-6">
            ...
            <flux:select class="mt-2" wire:model="form.parent">
                <flux:select.option value="">{{ __('Select a parent') }}</flux:select.option>
    ...
    <flux:modal name="category-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
